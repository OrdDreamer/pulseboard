...
Сервіс розгорнуто на **Render.com** і доступний за адресою:

**https://orddreamer-pulseboard.onrender.com/**

На сервісі вже завантажені тестові дані. Ви можете одразу протестувати функціонал, використовуючи наступні облікові дані:
